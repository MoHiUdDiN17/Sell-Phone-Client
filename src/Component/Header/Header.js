            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <div className='mr-3'><Link to='/dashboard'><li>Deshboard</li></Link></div>
                ...
                <img src={image} alt="" className='resizeing' />
                <p className="btn btn-ghost normal-case text-3xl text-orange-600">Sell-Phone</p>
            </div>
